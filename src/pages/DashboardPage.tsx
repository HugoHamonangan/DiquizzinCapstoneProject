...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-10 md:px-0 flex flex-col items-center justify-center gap-7 h-screen pt-9">
      <h1 className="font-extrabold text-[#F9A826] text-3xl w-full max-w-[40rem] text-center">HELLO {user?.name} WELCOME TO DIQUIZZIN LET'S START !!!</h1>
      <p className="w-full max-w-[40rem] text-center">Its ok to search the result on the internet, remember the important thing to do is you need to read the information, and become the person that rich of knowledge !!!</p>
